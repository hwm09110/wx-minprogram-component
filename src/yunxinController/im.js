...
const MD5 = require('../vendors/md5.js')
const NetcallController = require('./netcall.js')
...
// 重连 onWillConnect
module.exports = class IMController {
  constructor(headers) {
    app.globalData.nim = NIM.getInstance({
      // 初始化SDk
      // debug: true,
      appKey: app.globalData.YUNXIN_CONFIG.appkey,
      ...
      // 私有化配置文件
      privateConf: app.globalData.YUNXIN_CONFIG.openPrivateConf ? app.globalData.YUNXIN_CONFIG.privateConf : '',
      // 同步完成
 ...
 */
  ...
  onFriends(friends) {
    ...
    //   payload: friends
    // })
    if (app.globalData.YUNXIN_CONFIG.openSubscription) {
